...
public partial class AuroraRenderPipeline : RenderPipeline 
{
    ...
    //构造函数，初始化管线的一些属性
    //构造函数，初始化管线的一些属性
    public AuroraRenderPipeline(bool useDynamicBatching, bool useGPUInstancing, 
